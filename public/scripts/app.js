...
var AddOption = function (_React$Component6) {
  ...
  function AddOption(props) {
    ...
    _this6.handleClickAddOption = _this6.handleClickAddOption.bind(_this6);
    _this6.state = {
      error: undefined
    };
    return _this6;
  ...
  _createClass(AddOption, [{
    key: 'handleClickAddOption',
    value: function handleClickAddOption(e) {
      e.preventDefault();
      var optionText = e.target.elements.optionText.value.trim();
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'form',
          { onSubmit: this.handleClickAddOption.bind(this) },
